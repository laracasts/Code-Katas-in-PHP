...
/**
 * Custom Number to words singleton
 * For different solutions: https://github.com/kwn/number-to-words
 * Using the number formatter:
 *      $f = new \NumberFormatter("en", \NumberFormatter::SPELLOUT);
 *      $this->assertEquals($f->format(1432), 'one thousand four hundred thirty-two');
 * Here is a custom s
 */
class NumbersInWords
{
    /**
     * Covert a number to words
     *
